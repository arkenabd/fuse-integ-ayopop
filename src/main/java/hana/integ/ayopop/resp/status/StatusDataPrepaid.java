...
public class StatusDataPrepaid {
	...
	private List<StatusCustomerDetailPrepaid> customerDetails = null;
	...
	@JsonProperty("customerDetails")
	public List<StatusCustomerDetailPrepaid> getCustomerDetails() {
		return customerDetails;
	}

	@JsonProperty("customerDetails")
	public void setCustomerDetails(List<StatusCustomerDetailPrepaid> customerDetails) {
